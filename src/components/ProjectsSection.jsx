...
const projectImages = [
  {
    id: 1,
    title: "Dream Project 4: 3D Game of Destruction",
    imageSrc: "/images/project-1.png"
  },
  {
    id: 2,
    title: "Dream Project 4: A Pyschological Service Center",
    imageSrc: "/images/project-2.png"
  },
  {
    id: 3,
    title: "Dream Project 3:Medical Center",
    imageSrc: "/images/project-3.png"
  },
  {
    id: 4,
    title: "Dream Project 4:Universal English Language Assist",
...
const ProjectsSection = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="relative overflow-hidden bg-[#f6f6f6] py-20"
    >
      {/* Section Title */}
      <div className="container mx-auto px-4 mb-16 relative z-10">
        <h2
          ref={titleRef}
          className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-black mb-4 opacity-0"
        >
          Featured Projects
        </h2>
        <div
